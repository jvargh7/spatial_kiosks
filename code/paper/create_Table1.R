...
pursuantAll <- generate_pursuant_Table1(2017, 2018)
sink(here("results", "tables", "Table1_Pursuant_20172018.txt"))
print(pursuantAll)
sink()
pursuantAll <- generate_pursuant_Table1(2019, 2020)
sink(here("results", "tables", "Table1_Pursuant_20192020.txt"))
print(pursuantAll)
sink()
pursuantAll <- generate_pursuant_Table1(2021, 2022)
sink(here("results", "tables", "Table1_Pursuant_20212022.txt"))
print(pursuantAll)
sink()
pursuantAll <- generate_pursuant_Table1(2023, 2024)
sink(here("results", "tables", "Table1_Pursuant_20232024.txt"))
print(pursuantAll)
sink()
